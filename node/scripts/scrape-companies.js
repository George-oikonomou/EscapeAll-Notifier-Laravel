 ...
 * scrape-companies.js
 *
 * Playwright-based scraper for EscapeAll companies and areas.
 *
 * Usage (file mode):
 *   node scrape-companies.js format=json out=./companies.json language=el waitMs=5000
 *
 * Usage (webhook mode - GitHub Actions):
 *   node scrape-companies.js format=json language=el waitMs=6000 \
 *     webhookUrl=https://yourdomain.com/api/webhook/sync-companies \
